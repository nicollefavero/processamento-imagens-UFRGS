        ...
        while True:
            ...
            if event == "Carregar Imagem":
                ...
                if os.path.exists(filename):
                    image = trabalho02.carregarImagem(filename)
                    bio = io.BytesIO()
            ...
            if event == "Espelhamento Horizontal":
                ...
                if editLeft:
                    image = trabalho02.espelharImagemHorizontal(image)
                    image.save(bio, format="PNG")
                    self.janela["image"].update(data=bio.getvalue())
                    
                elif editRight:
                    image_copy = trabalho02.espelharImagemHorizontal(image_copy)
                    image_copy.save(bio, format="PNG")
                    self.janela["imageCopy"].update(data=bio.getvalue())
            ...
            if event == "Espelhamento Vertical":
                ...
                if editLeft:
                    image = trabalho02.espelharImagemVertical(image)
                    image.save(bio, format="PNG")
                    self.janela["image"].update(data=bio.getvalue())
                    
                elif editRight:
                    image_copy = trabalho02.espelharImagemVertical(image_copy)
                    image_copy.save(bio, format="PNG")
                    self.janela["imageCopy"].update(data=bio.getvalue())
            ...
            if event == "Luminância":
                ...
                if editLeft:
                    image = trabalho02.converterImagemParaCinza(image)
                    image.save(bio, format="PNG")
                    self.janela["image"].update(data=bio.getvalue())
                    
                elif editRight:
                    image_copy = trabalho02.converterImagemParaCinza(image_copy)
                    image_copy.save(bio, format="PNG")
                    self.janela["imageCopy"].update(data=bio.getvalue())
            ...
            if event == "Quantização":
                ...
                if editLeft:
                    image = trabalho02.quantizarImagemCinza(image, colors_num)
                    image.save(bio, format="PNG")
                    self.janela["image"].update(data=bio.getvalue())
                    
                elif editRight:
                    image_copy = trabalho02.quantizarImagemCinza(image_copy, colors_num)
                    image_copy.save(bio, format="PNG")
                    self.janela["imageCopy"].update(data=bio.getvalue())
            ...
            if event == "Salvar Imagem JPEG":
                ...
                if saveLeft:
                    trabalho02.salvarImagemJPEG(image, folderName + "/" + name)
                    print("Saved")
                elif saveRight:
                    trabalho02.salvarImagemJPEG(image_copy, folderName + "/" + name)
                    print("Saved")
